...
class NotificationsHelper {
  ...
  setupListeners() {
    try {
      ...
      // logger.warn('Error setting up notification listeners:', error);
    }
  }
  ...
  async scheduleNotifications(notifications) {
    ...
    try {
      ...
      // logger.warn('Error scheduling notifications:', error);
    }
    return false;
  }
  ...
  async cancelNotificationsByType(type) {
    ...
    try {
      ...
      // logger.warn('Error canceling notifications:', error);
    }
  }
