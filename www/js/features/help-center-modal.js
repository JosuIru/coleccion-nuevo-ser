...
class HelpCenterModal {
  ...
  render() {
    ...
    modal.className = 'fixed inset-0 bg-black/80 backdrop-blur-sm flex items-center justify-center z-50 p-0 sm:p-4 opacity-0 transition-opacity duration-200';

    modal.innerHTML = `
      <div class="bg-gray-900 rounded-none sm:rounded-2xl shadow-2xl max-w-5xl w-full h-full sm:h-[90vh] flex flex-col border-0 sm:border-2 border-cyan-500/30">
        ${this.renderHeader()}
