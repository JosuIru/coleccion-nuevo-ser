...
const ProfileScreen = ({ navigation }) => {
  ...
  const calculateDaysActive = () => {
    const createdAt = user.stats?.createdAt;
  ...
  // Estadísticas reales del store
  const stats = {
    crisesResolved: user.stats?.crisesResolved || 0,
    fractalsCollected: user.stats?.fractalsCollected || 0,
    beingsCreated: user.stats?.beingsCreated || totalBeings,
      ...
      <View style={styles.header}>
        ...
        <TouchableOpacity
          ...
          onPress={() => {
            ...
            // Scroll to settings when opening
          ...
          >
            ...
            <View style={styles.settingRow}>
              <View style={styles.settingInfo}>
                ...
                <Text style={styles.settingDescription}>
                  Vibración en acciones del juego
                </Text>
              </View>
              <Switch
