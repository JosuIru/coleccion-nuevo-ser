...
class FrankensteinLabUI {
  ...
  setRandomDaVinciBackground() {
    ...
    // Rutas relativas para compatibilidad con APK y web
    const vintageImages = [
        ...
        <header class="lab-header">
          <div class="lab-header-content">
            <div class="lab-header-titles">
              ...
              <p class="lab-subtitle">Creación de Seres Transformadores con Propósito</p>
            </div>
            <div class="lab-header-actions">
              <button class="lab-button secondary text-sm px-2 py-1.5 md:px-3" onclick="window.frankensteinLabUI.showSavedBeingsModal()" title="Ver seres guardados">
                <span class="hidden sm:inline">🗂️ Seres Guardados</span>
                <span class="sm:hidden">🗂️</span>
              </button>
              <button class="text-white hover:text-amber-400 transition-colors p-2" onclick="window.frankensteinLabUI.organism.hide()">
