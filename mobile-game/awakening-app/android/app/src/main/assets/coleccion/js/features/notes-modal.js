  ...
  render() {
    ...
    const html = `
      <div id="notes-modal"
           ...
           class="fixed inset-0 bg-black/80 backdrop-blur-sm z-[10000] flex items-center justify-center p-4 transition-opacity duration-200">
  ...
  renderHeader(bookData, chapter) {
    return `
      <div class="border-b border-slate-700 p-6 flex items-center justify-between bg-slate-800/50">
        <div class="flex-1">
          <h2 id="notes-modal-title" class="text-2xl font-bold mb-1 flex items-center gap-3">
