...
class AISettingsModal {
  ...
  render() {
    ...
    const html = `
      <div id="ai-settings-modal" class="fixed inset-0 bg-black/80 flex items-center justify-center z-50 p-4">
  ...
  showToast(message, type = 'info') {
    ...
    toast.className = `fixed bottom-6 right-6 ${colors[type]} text-white px-6 py-3 rounded-lg shadow-lg z-50 animate-fade-in`;
