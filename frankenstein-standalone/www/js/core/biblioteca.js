...
class Biblioteca {
  ...
  render() {
    ...
    const htmlCompleto = `
      <div class="biblioteca-container min-h-screen p-4 sm:p-6 ${isMobile ? 'has-bottom-nav' : ''}" style="${isMobile ? 'padding-bottom: 140px !important;' : ''}">
        ${this.renderHeader()}
  ...
  /**
   * Attach event listeners para la sección Explorar Biblioteca
   */
