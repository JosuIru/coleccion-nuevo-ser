var capacitorTextToSpeech = (function (exports, core) {
    ...
    if (!core || typeof core.registerPlugin !== 'function') {
        // console.warn('⚠️ Capacitor core not available, TTS plugin disabled');
        return exports;
    }
...
})({}, typeof capacitorExports !== 'undefined' ? capacitorExports : (typeof window !== 'undefined' && window.Capacitor ? window.Capacitor : undefined));
